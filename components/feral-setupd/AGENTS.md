...
The web app target is fixed to the bundled local player at `http://127.0.0.1:8080/`. Do not reintroduce `webapp_url` overrides from `ff1-config.json`; readiness belongs to `feral-ff-player-static.service`.
