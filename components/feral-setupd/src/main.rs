...
fn pairing_confirmation_promotes_to_ready(phase: SetupPhase, has_topic: bool) -> bool {
    match phase {
...
mod callbacks {
    use super::{
        ...
        get_setup_phase, internet_setup_successfully_cb, pairing_confirmation_promotes_to_ready,
