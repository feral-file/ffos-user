...
pub const LOG_UPLOAD_API: &str = "https://publisher.feralfile.com/v2/ff1/log-submissions";
...
pub const DBUS_EVENT_UPLOAD_LOGS_WITH_BUNDLE: &str = "upload_logs_with_bundle";
