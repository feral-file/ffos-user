...
//
//	mockgen -source=config.go -destination=../mocks/config.go -package=mocks -mock_names=ConfigManager=MockConfigManager
//
...
import (
	...
	config "github.com/feral-file/ffos-user/components/feral-controld/config"
)
...
func (mr *MockConfigManagerMockRecorder) Load(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
