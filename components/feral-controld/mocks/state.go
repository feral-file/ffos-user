...
//
//	mockgen -source=state.go -destination=../mocks/state.go -package=mocks -mock_names=StateManager=MockStateManager
//
...
func (mr *MockStateManagerMockRecorder) Load(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStateManagerMockRecorder) Save(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
