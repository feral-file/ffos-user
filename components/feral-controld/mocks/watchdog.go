...
//
//	mockgen -source=watchdog.go -destination=../mocks/watchdog.go -package=mocks -mock_names=Watchdog=MockWatchdog
//
...
func (mr *MockWatchdogMockRecorder) Start(ctx any) *gomock.Call {
