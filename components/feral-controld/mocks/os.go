...
//
//	mockgen -source=os.go -destination=../mocks/os.go -package=mocks -mock_names=Signal=MockSignal
//
...
func (mr *MockOSMockRecorder) ReadDir(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOSMockRecorder) ReadFile(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOSMockRecorder) WriteFile(path, data, perm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
