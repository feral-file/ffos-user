...
// Source: playlist-refresher/refresher.go
...
func (m *MockRefresher) ForceRefresh() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ForceRefresh")
}

// ForceRefresh indicates an expected call of ForceRefresh.
func (mr *MockRefresherMockRecorder) ForceRefresh() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForceRefresh", reflect.TypeOf((*MockRefresher)(nil).ForceRefresh))
}
