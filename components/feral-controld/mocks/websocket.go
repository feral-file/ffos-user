...
//
//	mockgen -source=websocket.go -destination=../mocks/websocket.go -package=mocks -mock_names=WebsocketUpgrader=MockWebsocketUpgrader
//
...
func (mr *MockWebSocketDialerMockRecorder) DialContext(ctx, url, requestHeader any) *gomock.Call {
...
func (mr *MockWebSocketConnMockRecorder) WriteControl(messageType, data, deadline any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWebSocketConnMockRecorder) WriteJSON(v any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
