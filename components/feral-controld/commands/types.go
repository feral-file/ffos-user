...
var deviceCtlCommands = map[Type]bool{
	...
	CMD_SHUTDOWN:                true,
	CMD_REBOOT:                  true,
	CMD_ANALYTICS_TOGGLE_OFF:    true,
	CMD_BETA_FEATURES_TOGGLE_ON: true,
...
const (
	...
	CMD_ANALYTICS_TOGGLE_OFF    Type = "analyticsToggleOff"
	CMD_BETA_FEATURES_TOGGLE_ON Type = "betaFeaturesToggleOn"
