...
func (mr *MockExecCmdMockRecorder) SetStderr(w interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetStderr", reflect.TypeOf((*MockExecCmd)(nil).SetStderr), w)
}
